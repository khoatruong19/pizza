...
const PizzaDetailPage = ({pizza}: IProps) => {
    ...
    const handleQuantity = (action: string) => {
        action === 'inc' ? setQuantity((prev) => prev + 1) : quantity === 1 ? null : setQuantity(prev => prev-1)
    }
            ...
            <div className={css.right}>
                ...
                <div className={css.quantity}>
                    ...
                    <div className={css.counter}>
                        <Image unoptimized onClick={() => handleQuantity('desc')} src={arrowLeft} alt="" height={20} width={20} objectFit="contain" />
                        <span>{quantity}</span>
                        <Image unoptimized onClick={() => handleQuantity('inc')} src={arrowRight} alt="" height={20} width={20} objectFit="contain" />
                    </div>
                </div>
